...
const RecipeAuthor = () => {
   ...
   return (
      <div>
         <img src={authorPhoto} alt ={authorName} style={{objectFit: "contain", borderRadius: "50%", maxWidth: "100px"}} />
         <div>
            <h3>{authorName}</h3>
            <a href={authorLink}>Author Website</a> 
         </div>
      </div>
   );
}
...
const RecipePhoto = () => {
   return (
      <img src="https://thecozycook.com/wp-content/uploads/2021/10/Stovetop-Mac-and-Cheese-2.jpg" alt="Stovetop Mac and Cheese" className="imageUpdates" style={{ width: "200px", padding: "10px"}} />
   );
}
